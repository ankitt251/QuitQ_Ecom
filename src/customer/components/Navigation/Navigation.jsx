  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-custom px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
        ...
        >
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              {/* Logo */}
              <div className="ml-4 flex items-center space-x-2 lg:ml-0">
